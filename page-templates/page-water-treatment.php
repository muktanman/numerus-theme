...
<div class="oil-gas-page">
    ...
    <section class="page-header">
        <div class="page-header-overlay">
            <div class="container">
                <h1 class="page-header-title">Water Treatment</h1>
    ...
    <section class="services-section section-with-bg-image">
        ...
        <div class="container section-content-layer">
            ...
            <div class="capability-cards">
                <?php
                $services = [
                    'Desalination plant operations and maintenance',
                    'Water purification system design and installation',
                    'Reverse osmosis plant management',
                    'Water quality testing and compliance',
                    'Emergency water supply for remote camps',
                    'Wastewater treatment and disposal',
                ];
                foreach ( $services as $svc ) {
                    echo '<div class="capability-card"><span class="capability-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></span><p><strong>' . esc_html( $svc ) . '</strong></p></div>';
                }
                ?>
            </div>
        </div>
