...
acf_add_local_field_group( [
    ...
    'fields' => [
        ...
        // ── TAB: Hero ──────────────────────────────────────────────────────
        [ 'key' => 'field_home_tab_hero', 'label' => 'Hero', 'name' => '', 'type' => 'tab' ],
        [
            'key'          => 'field_home_hero_title',
            'label'        => 'Hero Title',
            'name'         => 'hero_title',
            'type'         => 'text',
            'instructions' => 'Main headline displayed over the slideshow.',
        ],
        [
            ...
            'type'         => 'text',
            'instructions' => 'Label for the CTA button (e.g. "Partner With Us").',
            'wrapper'      => [ 'width' => '50' ],
        ],
        [
        ...
        [
            ...
            'layout'       => 'table',
            'instructions' => 'Images cycle automatically in the hero background slideshow.',
            'sub_fields'   => [
                [
                    'key'           => 'field_home_hero_slide_image',
                    'label'         => 'Image',
                    'name'          => 'slide_image',
                    'type'          => 'image',
                    'return_format' => 'url',
                ...
                [
                    'key'          => 'field_home_hero_slide_position',
                    'label'        => 'Position',
                    'name'         => 'slide_position',
                    'type'         => 'select',
                    'choices'      => [
                    ...
                    'instructions'  => 'Background-position for this slide.',
                ],
            ],
        ],
        ...
        [
            ...
            'sub_fields'   => [
                [
                    'key'           => 'field_home_sector_image',
                    'label'         => 'Background Image',
                    'name'          => 'sector_image',
                    'type'          => 'image',
                    'return_format' => 'url',
                    'preview_size'  => 'medium',
                    'instructions'  => 'Full-width background shown on desktop hover and as mobile card image.',
                    'wrapper'       => [ 'width' => '50' ],
                ],
                [
                    'key'           => 'field_home_sector_logo',
                    'label'         => 'Company Logo',
                    'name'          => 'sector_logo',
                    'type'          => 'image',
                    'return_format' => 'url',
                    'preview_size'  => 'thumbnail',
                    'instructions'  => 'Logo shown inside the sector card.',
                    'wrapper'       => [ 'width' => '50' ],
                ],
                [
                    'key'     => 'field_home_sector_title',
                    'label'   => 'Sector Title',
                    'name'    => 'sector_title',
                    'type'    => 'text',
                    'wrapper' => [ 'width' => '50' ],
                ...
                [
                    'key'   => 'field_home_sector_description',
        ...
        // ── TAB: Trusted by Global Leaders ────────────────────────────────
        [ 'key' => 'field_home_tab_clients', 'label' => 'Trusted by Global Leaders', 'name' => '', 'type' => 'tab' ],
        [
            'key'   => 'field_home_clients_title',
            'label' => 'Section Title',
            'name'  => 'clients_title',
            'type'  => 'text',
        ],
        [
            'key'          => 'field_home_clients',
            'label'        => 'Client Logos',
            'name'         => 'clients',
            'type'         => 'repeater',
        ...
        // ── TAB: Our Footprint ────────────────────────────────────────────
        [ 'key' => 'field_home_tab_footprint', 'label' => 'Our Footprint', 'name' => '', 'type' => 'tab' ],
        [
        ...
        // ── TAB: Legacy CTA ───────────────────────────────────────────────
        [ 'key' => 'field_home_tab_cta', 'label' => 'Legacy CTA', 'name' => '', 'type' => 'tab' ],
        [
            'key'          => 'field_home_cta_subtitle_1',
            'label'        => 'CTA — Bold Subtitle',
            'name'         => 'cta_subtitle_1',
            'type'         => 'textarea',
            'rows'         => 2,
            'instructions' => 'Displayed in bold above the second line.',
        ],
        [
            'key'   => 'field_home_cta_subtitle_2',
            'label' => 'CTA — Regular Subtitle',
            'name'  => 'cta_subtitle_2',
            'type'  => 'textarea',
            'rows'  => 2,
        ],
